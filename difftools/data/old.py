...
This file is for testing the output and rendering of tools for generatin and
showing diffs. This is the original file before changes have been applied in
`new.py`. It's a python file so you can test rendering of diffs with syntax
highlighting.
