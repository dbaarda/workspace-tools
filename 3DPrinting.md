...
General; Layer Height; Layer Height: 0.18->0.17mm
...
Infill; Top Layers: 4
	...
	Speed: Solid: 50%
	       First Top Layer: 50%
	       Sparse: 100%
Cooling; Dec area: 50mm^2
         delay area: 25mm^2
	 delay time: 3.0s
	fan control: On when first layer printed
	Back fan: always off
Advanced; Extrusion Ratio: 109%
          first layer: 109%
	  path width: 0.4mm
...
* Advanced; Extrusion Ratio: 109->100%
            First layer: 109->105%
...
Advanced; Extrusion Ratio: 100->105%
          First layer: 105->107%
Others:
...
General; Layer Height; Layer Height: 0.18->0.2mm
...
General; Layer Height; Layer Height: 0.2->0.17mm
...
Ring height 3.55
     diameter 16.01 5.75-5.91

Clip height:2.24 10.55
    diameter: 16.00 6.11 6.63
...
still melty mess at clip base. random start does remove starting "point", but
...
Really crap. Started to warp even. was strong though.
...
Very pretty, with base seam being the worst artifact, and some small easily
removed seam-beads on clips.

Weak as piss though, with clips snapping off easily.
